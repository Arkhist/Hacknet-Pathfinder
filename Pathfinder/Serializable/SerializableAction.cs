...
namespace Pathfinder.Serializable.Action
{
    public interface Interface
    {
        void OnTrigger(OS os);
        void OnRead(Instance instance, SaxProcessor.ElementInfo info);
    }

    public class Instance : Hacknet.SerializableAction
    {
        ...
        {
            var inter = Handler.GetActionById(ref id);
            if (inter == null)
                return null;
        ...
        public override void Trigger(object os_obj) => Interface.OnTrigger((OS)os_obj);
