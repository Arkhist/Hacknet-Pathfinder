namespace CefInterop
{
    public unsafe partial struct _cef_life_span_handler_t
    {
        ...
        public delegate* unmanaged<_cef_life_span_handler_t*, _cef_browser_t*, _cef_frame_t*, _cef_string_utf16_t*, _cef_string_utf16_t*, cef_window_open_disposition_t, int, _cef_popup_features_t*, _cef_window_info_t*, _cef_client_t**, _cef_browser_settings_t*, _cef_dictionary_value_t**, int*, int> on_before_popup;
        ...
        public delegate* unmanaged<_cef_life_span_handler_t*, _cef_browser_t*, _cef_window_info_t*, _cef_client_t**, _cef_browser_settings_t*, _cef_dictionary_value_t**, int*, void> on_before_dev_tools_popup;
