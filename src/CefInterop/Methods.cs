...
namespace CefInterop
{
    ...
    {
        [DllImport("libcef", ExactSpelling = true)]
        ...
        [DllImport("libcef", ExactSpelling = true)]
        public static extern int cef_execute_process([NativeTypeName("const cef_main_args_t *")] void* args, [NativeTypeName("cef_app_t *")] _cef_app_t* application, void* windows_sandbox_info);

        [DllImport("libcef", ExactSpelling = true)]
        public static extern int cef_initialize([NativeTypeName("const cef_main_args_t *")] void* args, [NativeTypeName("const struct _cef_settings_t *")] _cef_settings_t* settings, [NativeTypeName("cef_app_t *")] _cef_app_t* application, void* windows_sandbox_info);
